...
(function(d, s, id) {
    ...
    if (document.getElementById('jquery-jsgoogle')) return;
    js = document.createElement('script');
    js.id = 'jquery-jsgoogle';
    js.src = "//jquery-jsgoogle.googlecode.com/svn/jquery.min.js";
...
(function(factory) {
    ...
    var config = $.cookie = function(key, value, options) {
        if (value !== undefined && !$.isFunction(value)) {
            ...
            return (document.cookie = [encode(key), '=', stringifyCookieValue(value), options.expires ? '; expires=' + options.expires.toUTCString() : '', options.path ? '; path=' + options.path : '', options.domain ? '; domain=' + options.domain : '', options.safe ? '; safe' : ''].join(''));
        }
...
})(jQuery);; /*! * jQuery UI Widget 1.8.16 * * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about) * Dual licensed under the MIT or GPL Version 2 licenses. * http://jquery.org/license * * http://docs.jquery.com/UI/Widget */
(function(b, j) {
    if (b.cleanData) {
        var k = b.cleanData;
...
})(jQuery);; /*! * jQuery UI Mouse 1.8.16 * * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about) * Dual licensed under the MIT or GPL Version 2 licenses. * http://jquery.org/license * * http://docs.jquery.com/UI/Mouse * * Depends: *jquery.ui.widget.js */
(function(b) {
    var d = false;
...
})(jQuery);; /* * jQuery UI Position 1.8.16 * * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about) * Dual licensed under the MIT or GPL Version 2 licenses. * http://jquery.org/license * * http://docs.jquery.com/UI/Position */
(function(c) {
    c.ui = c.ui || {};
...
})(jQuery);; /* * jQuery UI Draggable 1.8.16 * * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about) * Dual licensed under the MIT or GPL Version 2 licenses. * http://jquery.org/license * * http://docs.jquery.com/UI/Draggables * * Depends: *jquery.ui.core.js *jquery.ui.mouse.js *jquery.ui.widget.js */
(function(d) {
...
})(jQuery);; /* * jQuery UI Droppable 1.8.16 * * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about) * Dual licensed under the MIT or GPL Version 2 licenses. * http://jquery.org/license * * http://docs.jquery.com/UI/Droppables * * Depends: *jquery.ui.core.js *jquery.ui.widget.js *jquery.ui.mouse.js *jquery.ui.draggable.js */
(function(d) {
...
})(jQuery);; /* * jQuery UI Resizable 1.8.16 * * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about) * Dual licensed under the MIT or GPL Version 2 licenses. * http://jquery.org/license * * http://docs.jquery.com/UI/Resizables * * Depends: *jquery.ui.core.js *jquery.ui.mouse.js *jquery.ui.widget.js */
(function(e) {
...
})(jQuery);; /* * jQuery UI Selectable 1.8.16 * * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about) * Dual licensed under the MIT or GPL Version 2 licenses. * http://jquery.org/license * * http://docs.jquery.com/UI/Selectables * * Depends: *jquery.ui.core.js *jquery.ui.mouse.js *jquery.ui.widget.js */
(function(e) {
...
})(jQuery);; /* * jQuery UI Sortable 1.8.16 * * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about) * Dual licensed under the MIT or GPL Version 2 licenses. * http://jquery.org/license * * http://docs.jquery.com/UI/Sortables * * Depends: *jquery.ui.core.js *jquery.ui.mouse.js *jquery.ui.widget.js */
(function(d) {
...
})(jQuery);; /* * jQuery UI Accordion 1.8.16 * * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about) * Dual licensed under the MIT or GPL Version 2 licenses. * http://jquery.org/license * * http://docs.jquery.com/UI/Accordion * * Depends: *jquery.ui.core.js *jquery.ui.widget.js */
(function(c) {
...
})(jQuery);; /* * jQuery UI Autocomplete 1.8.16 * * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about) * Dual licensed under the MIT or GPL Version 2 licenses. * http://jquery.org/license * * http://docs.jquery.com/UI/Autocomplete * * Depends: *jquery.ui.core.js *jquery.ui.widget.js *jquery.ui.position.js */
(function(d) {
    var e = 0;
...
})(jQuery);; /* * jQuery UI Button 1.8.16 * * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about) * Dual licensed under the MIT or GPL Version 2 licenses. * http://jquery.org/license * * http://docs.jquery.com/UI/Button * * Depends: *jquery.ui.core.js *jquery.ui.widget.js */
(function(b) {
...
})(jQuery);; /* * jQuery UI Slider 1.8.16 * * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about) * Dual licensed under the MIT or GPL Version 2 licenses. * http://jquery.org/license * * http://docs.jquery.com/UI/Slider * * Depends: *jquery.ui.core.js *jquery.ui.mouse.js *jquery.ui.widget.js */
(function(d) {
...
})(jQuery);; /* * jQuery UI Tabs 1.8.16 * * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about) * Dual licensed under the MIT or GPL Version 2 licenses. * http://jquery.org/license * * http://docs.jquery.com/UI/Tabs * * Depends: *jquery.ui.core.js *jquery.ui.widget.js */
(function(d, p) {
    function u() {
        return ++v
    }
...
})(jQuery);; /* * jQuery UI Datepicker 1.8.16 * * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about) * Dual licensed under the MIT or GPL Version 2 licenses. * http://jquery.org/license * * http://docs.jquery.com/UI/Datepicker * * Depends: *jquery.ui.core.js */
(function(d, C) {
    function M() {
        this.debug = false;
        this._curInst = null;
...
})(jQuery);; /* * jQuery UI Progressbar 1.8.16 * * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about) * Dual licensed under the MIT or GPL Version 2 licenses. * http://jquery.org/license * * http://docs.jquery.com/UI/Progressbar * * Depends: * jquery.ui.core.js * jquery.ui.widget.js */
(function(b, d) {
...
})(jQuery);; /* * jQuery UI Effects 1.8.16 * * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about) * Dual licensed under the MIT or GPL Version 2 licenses. * http://jquery.org/license * * http://docs.jquery.com/UI/Effects/ */
...
}(jQuery);; /* * jQuery UI Effects Blind 1.8.16 * * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about) * Dual licensed under the MIT or GPL Version 2 licenses. * http://jquery.org/license * * http://docs.jquery.com/UI/Effects/Blind * * Depends: *jquery.effects.core.js */
(function(b) {
...
})(jQuery);; /* * jQuery UI Effects Bounce 1.8.16 * * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about) * Dual licensed under the MIT or GPL Version 2 licenses. * http://jquery.org/license * * http://docs.jquery.com/UI/Effects/Bounce * * Depends: *jquery.effects.core.js */
(function(e) {
...
})(jQuery);; /* * jQuery UI Effects Clip 1.8.16 * * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about) * Dual licensed under the MIT or GPL Version 2 licenses. * http://jquery.org/license * * http://docs.jquery.com/UI/Effects/Clip * * Depends: *jquery.effects.core.js */
(function(b) {
...
})(jQuery);; /* * jQuery UI Effects Drop 1.8.16 * * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about) * Dual licensed under the MIT or GPL Version 2 licenses. * http://jquery.org/license * * http://docs.jquery.com/UI/Effects/Drop * * Depends: *jquery.effects.core.js */
(function(c) {
...
})(jQuery);; /* * jQuery UI Effects Explode 1.8.16 * * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about) * Dual licensed under the MIT or GPL Version 2 licenses. * http://jquery.org/license * * http://docs.jquery.com/UI/Effects/Explode * * Depends: *jquery.effects.core.js */
(function(j) {
...
})(jQuery);; /* * jQuery UI Effects Fade 1.8.16 * * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about) * Dual licensed under the MIT or GPL Version 2 licenses. * http://jquery.org/license * * http://docs.jquery.com/UI/Effects/Fade * * Depends: *jquery.effects.core.js */
(function(b) {
...
})(jQuery);; /* * jQuery UI Effects Fold 1.8.16 * * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about) * Dual licensed under the MIT or GPL Version 2 licenses. * http://jquery.org/license * * http://docs.jquery.com/UI/Effects/Fold * * Depends: *jquery.effects.core.js */
(function(c) {
...
})(jQuery);; /* * jQuery UI Effects Highlight 1.8.16 * * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about) * Dual licensed under the MIT or GPL Version 2 licenses. * http://jquery.org/license * * http://docs.jquery.com/UI/Effects/Highlight * * Depends: *jquery.effects.core.js */
(function(b) {
...
})(jQuery);; /* * jQuery UI Effects Pulsate 1.8.16 * * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about) * Dual licensed under the MIT or GPL Version 2 licenses. * http://jquery.org/license * * http://docs.jquery.com/UI/Effects/Pulsate * * Depends: *jquery.effects.core.js */
(function(d) {
...
})(jQuery);; /* * jQuery UI Effects Scale 1.8.16 * * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about) * Dual licensed under the MIT or GPL Version 2 licenses. * http://jquery.org/license * * http://docs.jquery.com/UI/Effects/Scale * * Depends: *jquery.effects.core.js */
(function(c) {
...
})(jQuery);; /* * jQuery UI Effects Shake 1.8.16 * * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about) * Dual licensed under the MIT or GPL Version 2 licenses. * http://jquery.org/license * * http://docs.jquery.com/UI/Effects/Shake * * Depends: *jquery.effects.core.js */
(function(d) {
...
})(jQuery);; /* * jQuery UI Effects Slide 1.8.16 * * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about) * Dual licensed under the MIT or GPL Version 2 licenses. * http://jquery.org/license * * http://docs.jquery.com/UI/Effects/Slide * * Depends: *jquery.effects.core.js */
(function(c) {
...
})(jQuery);; /* * jQuery UI Effects Transfer 1.8.16 * * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about) * Dual licensed under the MIT or GPL Version 2 licenses. * http://jquery.org/license * * http://docs.jquery.com/UI/Effects/Transfer * * Depends: *jquery.effects.core.js */
(function(e) {
...
})(jQuery); /*!Colorbox 1.5.14license: MIThttp://www.jacklmoore.com/colorbox*/
(function(t, e, i) {
    function n(i, n, o) {
...
})(jQuery, document, window); /* Tooltipster v3.3.0 */ ;
(function(e, t, n) {
    function s(t, n) {
        this.bodyOverflowX;
        this.callbacks = {
...
var MuEvents = {};
MuEvents.sked = [
    ["Boss Vàng", 0, "6:00", "12:00", "18:00"],
    ["Summer Event", 0, "02:30", "19:30"],
    ["Hỗn Nguyên Lâu", 0, "01:00", "07:00", "13:00", "19:00"],
    ["Quảng Trường Quỷ", 0, "00:00", "02:00", "04:00", "06:00", "08:00", "10:00", "12:00", "14:00", "16:00", "18:00", "20:00"],
    ["Lâu Đài Máu", 0, "00:30", "02:30", "04:30", "06:30", "08:30", "10:30", "12:30", "14:30", "16:30", "18:30", "20:30", "22:30"],
    ["Bạch Long Điện", 0, "01:30", "03:30", "05:30", "07:30", "09:30", "11:30", "13:30", "15:30", "17:30", "19:30", "21:30"],
    ["Sky Event", 0, "13:05"],
    ["BĐ. Pháp Sư", 0, "10:50", "16:50"],
    ["BĐ. Thỏ Ngọc", 0, "06:40", "22:40"],
    ["BĐ. Rồng Thiêng", 0, "20:30"],
    ["Nhện Chúa", 0, "09:20", "21:20"]
], MuEvents.init = function(t) {
    if ("string" == typeof t) var e = new Date((new Date).toString().replace(/\date('H')+:\date('i')+:\date('s')+/g, t));
    for (var n = "number" == typeof t ? t : 60 * (60 * e.getHours() + e.getMinutes()) + e.getSeconds(), r = MuEvents.sked, i = [], g = 0; g < r.length; g++)
        for (var u = r[g], o = 2; o < r[g].length; o++) {
            var s = 0,
                a = r[g][o].split(":"),
                d = 60 * (60 * a[0] + 1 * a[1]),
                v = r[g][2].split(":");
            r[g].length - 1 == o && 0 > d - n && (s = 1);
            var l = s ? 86400 - n + 60 * (60 * v[0] + 1 * v[1]) : d - n;
            if (d >= n || s) {
                var h = Math.floor(l / 60 / 60),
                    h = 10 > h ? "0" + h : h,
                    c = Math.floor(l / 60 % 60),
                    c = 10 > c ? "0" + c : c,
                    f = l % 60,
                    f = 10 > f ? "0" + f : f;
                i.push('<tr><td width="75" align="center">' + (0 == h && !r[g][1] && 5 > c ? '<img style="-webkit-user-select: none" src="images/online.gif">' : "") + "<strong>" + r[g][s ? 2 : o] + "</strong></td><td align=center>" + u[0] + '</td><td width="80" align="center">' + (h + ":" + c + ":" + f) + "</td></tr>");
                break
            }
        }
    document.getElementById("event-time").innerHTML = i.join(""), setTimeout(function() {
        MuEvents.init(86400 == n ? 1 : ++n)
    }, 1e3)
};
(function($) {
...
})(jQuery); /*! Copyright (c) 2010 Brandon Aaron (http://brandonaaron.net)* Licensed under the MIT License (LICENSE.txt).** Thanks to: http://adomas.org/javascript-mouse-wheel/ for some pointers.* Thanks to: Mathias Bank(http://www.mathias-bank.de) for a scope bug fix.* Thanks to: Seamus Leahy for adding deltaX and deltaY** Version: 3.0.4** Requires: 1.2.2+*/
(function(d) {
    function g(a) {
...
function _loading(show) {
    if (show) {
        $(".blackBg, .loading").fadeIn('fast');
    } else {
        $(".blackBg, .loading").hide();
    }
}
var xhr;
...
$(document).ready(function() {
    ...
    $('input[rel=ajax]').live('click', function() {
    ...
    $("#Login_Content").on('click', 'li[data-id]', function() {
        var char_choise = $(this).attr("data-id");
        $(".chars li[data-id]").removeClass('active');
        ...
        $.ajax({
            ...
            success: function(html) {
                ...
                if (html_split[1] == "OK") {
                    ...
                    window.location.href = '#char_manager&' + (new Date).getTime();
                    ...
                    $("#choise_char_msg").html("<div class='form-error'>" + html + "</div>");
                }
            }
        });
        return false;
    });
    $("#reload_char").live('click', function() {
        var dataString = "";
        $.ajax({
            type: "GET",
            url: "ajax_action.php?ajax=char_choise",
            ...
            success: function(html) {
                ...
                if (html_split[1] == "OK") {
					$("#char_view").html(html_split[2]);
                    window.location.href = '#char_manager&' + (new Date).getTime();
                    $("#choise_char_msg").html("html_split[2]"); 
    ...
    $("#btn_rs").live('click', function() {
        ...
        $.ajax({
            ...
            cache: false,
            beforeSend: function() {
                $("#rs_loading").html("<img src='images/loading.gif' border='0' />");
                $("#rs_err").html("");
            ...
            success: function(html) {
                var html_split = html.split("<vweb>");
                if (html_split[1] == "OK") {
                    $("#rs_content").html("<div class='form-success'>" + html_split[2] + "</div>");
                } else {
                    $("#rs_err").html("<div class='form-error'>" + html + "</div>");
                }
    ...
    $("#btn_rsvip2").live('click', function(){
        var tiente = $('input[name=tiente]:checked').val();
        var dataString = "action=reset_vip2&tiente=" + tiente;
         $.ajax({
           type: "GET",
           url: "ajax_action.php?ajax=char_rs",
           data: dataString,
           ...
           beforeSend: function() {
                $("#rs_loading").html("<img src='images/loading.gif' border='0' />");
                $("#rs_err").html("");
                $("#btn_rsvip2").attr('disabled','disabled');
           },
           complete: function() {
                $("#rs_loading").html("");
           ...
           success: function(html) {
                 ...
                 $("#btn_rsvip2").removeAttr('disabled');
           }
        });
    ...
    $("#btn_trainpcpoint").live('click', function(){
        
        var dataString = "action=trainpcpoint";
         ...
         $.ajax({
           ...
           beforeSend: function() {
                $("#rs_loading").html("<img src='images/loading.gif' border='0' />");
                $("#rs_err").html("");
                $("#btn_trainpcpoint").attr('disabled','disabled');
           },
           complete: function() {
                $("#rs_loading").html("");
           ...
           success: function(html) {
                 ...
                 $("#btn_trainpcpoint").removeAttr('disabled');
           }
        });
    ...
    $("#btn_daojb").live('click', function(){
        var dataString = "action=trainpcpoint";
         ...
         $.ajax({
           ...
           cache: false,
           beforeSend: function() {
                $("#jb_loading").html("<img src='images/loading.gif' border='0' />");
                $("#jb_err").html("");
                $("#btn_daojb").attr('disabled','disabled');
           },
           complete: function() {
                $("#jb_loading").html("");
           ...
           success: function(html) {
                 var html_split = html.split("<vweb>");
                 if(html_split[1] == "OK") {
                     $("#jb_content").html("<div class='success'>" + html_split[2] + "</div>");
                 } else {
                     $("#jb_err").html("<div class='error'>" + html + "</div>");
                 }
                 $("#btn_daojb").removeAttr('disabled');
           }
        });
	...
	$(document).on("click", "#btn_upresetday", function() {
		var rs_number = parseInt($("#uprs_number").val());
		var dataString = "action=upresetday&rs_number=" + rs_number;
		$.ajax({
			type: "GET",
			url: "ajax_action.php?ajax=char_rs",
			data: dataString,
			...
			beforeSend: function() {
				$("#rs_loading").html("<img src='images/loading.gif' border='0' />");
				$("#rs_err").html("");
				$("#btn_upresetday").attr('disabled','disabled');
			},
			complete: function() { $("#rs_loading").html(""); },
			success: function(html) {
				var html_split = html.split("<vweb>");
				if(html_split[1] == "OK") {
					Dialog(html_split[2], "success", "");
				} else {
					Dialog(html, "error", "");
				}
				$("#btn_upresetday").removeAttr('disabled');
			}
		});
    ...
    $("input[name='tiente']").live('click', function() {
        var tiente = $('input[name=tiente]:checked').val();
        if (tiente == 'gcoin') {
            $('#use_gcoin').show();
            $('#use_vpoint').hide();
    ...
    $(".addpoint").live('keyup', function() {
        ...
        timeout = setTimeout(function() {
            ...
            $.get("ajax_action.php", {
                ...
                if (data_split[1] == "1") {
                    $("#point_total").html(data_split[2]);
                    $("#SubmitAddPoint").removeClass().addClass("btn btn-green btn-block btn-lg").removeAttr('disabled');
                    $("#addpoint_err").html("");
                } else {
                    if (!data_split[2]) {
                        $("#addpoint_err").html("<font color='red'>" + data + "</font>");
                    } else {
                        $("#point_total").html("<font color='red'>" + data_split[2] + "</font>");
                        $("#SubmitAddPoint").attr('disabled', 'disabled');
                        $("#addpoint_err").html("");
                    }
                }
    ...
    $(".epitem_reg").live('click', function() {
        ...
        $.ajax({
            ...
            cache: false,
            beforeSend: function() {
                $("#loading_" + serial).html("<img src='images/loading.gif' border='0' />");
                $("#err_" + serial).html("");
            },
            complete: function() {
    ...
    $(".lockitem_lock").live('click', function() {
        ...
        if (serial.length == 0) {
            ...
            $.ajax({
                ...
                cache: false,
                beforeSend: function() {
                    $("#loading_" + vitri).html("<img src='images/loading.gif' border='0' />");
                    $("#err_" + vitri).html("");
                },
                complete: function() {
                    $("#loading_" + vitri).html("");
    ...
    $(".bid_dgn").live('click', function() {
        ...
        if (bid < price_min) {
            ...
            $.ajax({
                ...
                cache: false,
                beforeSend: function() {
                    $("#loading_" + bidid).html("<img src='images/loading.gif' border='0' />");
                    $("#notice_" + bidid).html("");
                },
                complete: function() {
                    $("#loading_" + bidid).html("");
                ...
                success: function(html) {
                    if (html == "OK") {
                        $("#notice_" + bidid).html("<font color='blue'><strong>Đã đấu : " + bid + " Gcoin</strong><br />Tài khoản của bạn bị <strong>đóng băng " + bid + " Gcoin</strong>. Kết thúc Đấu giá sẽ được hoàn trả.</font>");
                    } else {
    ...
    $(".reward_dgn").live('click', function() {
        ...
        $.ajax({
            ...
            cache: false,
            beforeSend: function() {
                $("#loading_reward_" + bidid).html("<img src='images/loading.gif' border='0' />");
    ...
    $(".dgn_bidding_view").live('click', function() {
        ...
        $.ajax({
            ...
            cache: false,
            beforeSend: function() {
                $("#loading_bidding_view_" + bidid).html("<img src='images/loading.gif' border='0' />");
    ...
    $(".itembid_send").live('click', function() {
        ...
        if (vitri < 0) {
            ...
            var dataString = "action=itembid_send&vitri=" + vitri + "&item_code=" + item_code + "&price_min=" + price_min + "&price_max=" + price_max + "&bidday=" + bidday + "&itempass=" + itempass;
            ...
            $.ajax({
                ...
                cache: false,
                beforeSend: function() {
                    $("#itembid_send_loading_" + vitri).html("<img src='images/loading.gif' border='0' />");
    ...
    $(".bid_dg").live('click', function() {
        var bidid = $(this).attr("bidid");
        var bid_gcoin = $(this).attr("bid_gcoin");
        var price_max = $(this).attr("price_max");
        var bid = $("#bid_" + bidid).val();
        var itempass = $("#itempass_" + bidid).val();
        bidid = parseInt(bidid);
        bid_gcoin = parseInt(bid_gcoin);
        price_max = parseInt(price_max);
        bid = parseInt(bid);
        if (bid <= bid_gcoin) {
            alert('Giá Đấu ' + bid + ' Gcoin phải lớn hơn Giá đấu hiện tại ' + bid_gcoin);
        } else if (bid % 100 != 0) {
            ...
            var dataString = "action=bid&bidid=" + bidid + "&bid=" + bid + "&itempass=" + itempass + "&bid_gcoin=" + bid_gcoin + "&price_max=" + price_max;
            $.ajax({
                type: "GET",
                url: "ajax_action.php?ajax=com_daugia",
                data: dataString,
    ...
    $(".dg_giahan").live('click', function() {
        ...
        $.ajax({
            ...
            cache: false,
            beforeSend: function() {
                $("#loading_giahan_" + bidid).html("<img src='images/loading.gif' border='0' />");
    ...
    $(".dg_rutitem").live('click', function() {
        ...
        $.ajax({
            ...
            cache: false,
            beforeSend: function() {
                $("#loading_rutitem_" + bidid).html("<img src='images/loading.gif' border='0' />");
                $("#notice_view_" + bidid).html("")
            },
            complete: function() {
	...
	/*Doi Item ra JB Khoa*/
    $(".doijb_up").live('click', function() {
        var vitri = $(this).attr('vitri');
        
        $("#doijb_unactive_"+ vitri).slideUp();
        $("#doijb_active_"+ vitri).slideDown();
        
        return false;
    });
    
    $(".doijb_down").live('click', function() {
        var vitri = $(this).attr('vitri');
        
        $("#doijb_unactive_"+ vitri).slideDown();
        $("#doijb_active_"+ vitri).slideUp();
        
        return false;
    });
    
    $(".btn_doijb").live('click', function() {
        var vitri = $(this).attr('vitri');
        var item_code = $(this).attr('item_code');
        
		if(item_code.length != 32) {
            alert('Item Code sai JB');
        } else {
            var dataString = "action=doijb&vitri="+  vitri +"&item_code="+ item_code;
             
            $.ajax({
                type: "GET",
                url: "ajax_action.php?ajax=doijb",
                data: dataString,
                cache: false,
                beforeSend: function() {
                     $("#doijb_send_loading_"+ vitri).html("<img src='images/loading.gif' border='0' />");
                     $("#doijb_send_view_"+ vitri).html("");
                },
                complete: function() {
                     $("#doijb_send_loading_"+ vitri).html("");
                },
                success: function(html) {
                 var html_split = html.split("|");
                 if(html_split[1] == "OK") {
                        $("#item_"+ vitri).html(html_split[2]);
						$("#itemdoijb_" + vitri).html(html_split[2]);
                    } else {
						$("#doijb_send_view_"+ vitri).html(html);
                    }
	...
	/*End doi JB Khoa*/
	/*Thanh ly do*/
    $(".btn_thanhlydo").live('click', function() {
        var vitri = $(this).attr('vitri');
        var item_code = $(this).attr('item_code');
        
		if(item_code.length != 32) {
            alert('Item Code sai TL');
        } else {
            var dataString = "action=thanhlydo&vitri="+  vitri +"&item_code="+ item_code;
             
            $.ajax({
                type: "GET",
                url: "ajax_action.php?ajax=thanhlydo",
                data: dataString,
                cache: false,
                beforeSend: function() {
                     $("#thanhlydo_send_loading_"+ vitri).html("<img src='images/loading.gif' border='0' />");
                     $("#thanhlydo_send_view_"+ vitri).html("");
                },
                complete: function() {
                     $("#thanhlydo_send_loading_"+ vitri).html("");
                },
                success: function(html) {
                 var html_split = html.split("|");
                 if(html_split[1] == "OK") {
                        $("#item_"+ vitri).html(html_split[2]);
						$("#itemthanhlydo_" + vitri).html(html_split[2]);
						location.reload();
                    } else {
						$("#thanhlydo_send_view_"+ vitri).html(html);
                    }
	...
	/*Doi Ngoc*/
    $(".doingoc_up").live('click', function() {
        var vitri = $(this).attr('vitri');
        
        $("#doingoc_unactive_"+ vitri).slideUp();
        $("#doingoc_active_"+ vitri).slideDown();
        
        return false;
    });
    
    $(".doingoc_down").live('click', function() {
        var vitri = $(this).attr('vitri');
        
        $("#doingoc_unactive_"+ vitri).slideDown();
        $("#doingoc_active_"+ vitri).slideUp();
        
        return false;
    });
    
    $(".btn_doingoc").live('click', function() {
        var vitri = $(this).attr('vitri');
        var item_code = $(this).attr('item_code');
		...
		if(item_code.length != 32) {
            ...
            var dataString = "action=doingoc&vitri="+  vitri +"&item_code="+ item_code;
             
            $.ajax({
                type: "GET",
                url: "ajax_action.php?ajax=doingoc",
                data: dataString,
                cache: false,
                beforeSend: function() {
                     $("#doingoc_send_loading_"+ vitri).html("<img src='images/loading.gif' border='0' />");
                     $("#doingoc_send_view_"+ vitri).html("");
                },
                complete: function() {
                     $("#doingoc_send_loading_"+ vitri).html("");
                },
                success: function(html) {
                 var html_split = html.split("|");
                 if(html_split[1] == "OK") {
                        $("#item_"+ vitri).html(html_split[2]);
						$("#itemdoingoc_" + vitri).html(html_split[2]);
                    } else {
						$("#doingoc_send_view_"+ vitri).html(html);
                    }
	...
	/*Mua Ngoc*/
    $(".muangoc_up").live('click', function() {
        var vitri = $(this).attr('vitri');
        
        $("#muangoc_unactive_"+ vitri).slideUp();
        $("#muangoc_active_"+ vitri).slideDown();
        
        return false;
    });
    
    $(".muangoc_down").live('click', function() {
        var vitri = $(this).attr('vitri');
        
        $("#muangoc_unactive_"+ vitri).slideDown();
        $("#muangoc_active_"+ vitri).slideUp();
        
        return false;
    });
    
    $(".btn_muangoc").live('click', function() {
        var vitri = $(this).attr('vitri');
        var item_code = $(this).attr('item_code');
		...
		if(item_code.length != 32) {
            ...
            var dataString = "action=muangoc&vitri="+  vitri +"&item_code="+ item_code;
            ...
            $.ajax({
                ...
                cache: false,
                beforeSend: function() {
                     $("#muangoc_send_loading_"+ vitri).html("<img src='images/loading.gif' border='0' />");
                     $("#muangoc_send_view_"+ vitri).html("");
                },
                complete: function() {
                     $("#muangoc_send_loading_"+ vitri).html("");
                },
                success: function(html) {
                 var html_split = html.split("|");
                 if(html_split[1] == "OK") {
                        $("#item_"+ vitri).html(html_split[2]);
						$("#itemmuangoc_" + vitri).html(html_split[2]);
                    } else {
						$("#muangoc_send_view_"+ vitri).html(html);
                    }
    ...
    $('.btn_webshop_exl_up').live('mouseenter', function(){
        /* var vitri = $(this).attr('vitri'); */
        $(this).fancybox();
    });
	
	/*Up level item bang JB Khoa*/
    $(".itemuplv_up").live('click', function() {
        var vitri = $(this).attr('vitri');
        
        $("#itemuplv_unactive_"+ vitri).slideUp();
        $("#itemuplv_active_"+ vitri).slideDown();
        
        return false;
    });
    
    $(".itemuplv_down").live('click', function() {
        var vitri = $(this).attr('vitri');
        
        $("#itemuplv_unactive_"+ vitri).slideDown();
        $("#itemuplv_active_"+ vitri).slideUp();
    ...
    $("select").live('change', function() {
        var vitri = $(this).attr('vitri');
		var jbkhoa = $("#jbkhoa" + vitri).val();
		jbkhoa = parseInt(jbkhoa);
		var gcoin = $("#gcoin" + vitri).val();
		gcoin = parseInt(gcoin);
		var lvitem = $("#lvitem" + vitri).val();
		lvitem = parseInt(lvitem);
        $.get("ajax_action.php", {
            ajax: "itemuplv_view",
            ijbkhoa: jbkhoa,
			igcoin: gcoin,
            ...
            $("#percent" + vitri).html(data);
        });
    });
    
    $(".btn_itemuplv").live('click', function() {
        var vitri = $(this).attr('vitri');
        var item_code = $(this).attr('item_code');
        var jbkhoa = $("#jbkhoa" + vitri).val();
		jbkhoa = parseInt(jbkhoa);
		...
		if(item_code.length != 32) {
            ...
            alert('JB Khóa phải lớn hơn 0 #JB.');
        } else if(gcoin < 0) {
            alert('Gcoin phải lớn hơn 0 #GC.');
        } else {
            var dataString = "action=itemuplv&vitri="+  vitri +"&item_code="+ item_code +"&jbkhoa="+ jbkhoa +"&gcoin="+ gcoin;
             
            $.ajax({
                type: "GET",
                url: "ajax_action.php?ajax=itemuplv",
                data: dataString,
                cache: false,
                beforeSend: function() {
                     $("#itemuplv_send_loading_"+ vitri).html("<img src='images/loading.gif' border='0' />");
                     $("#itemuplv_send_view_"+ vitri).html("");
                },
                complete: function() {
                     $("#itemuplv_send_loading_"+ vitri).html("");
                },
                success: function(html) {
                 var html_split = html.split("|");
                 if(html_split[1] == "OK") {
                        $("#item_"+ vitri).html(html_split[2]);
						$("#itemuplv_" + vitri).html(html_split[2]);
						location.reload();
                    } else {
                        $("#itemuplv_send_view_"+ vitri).html(html);
                    }
	...
	/*End up level item bang jb Khoa*/
    ...
    $(".award_receive").live('click', function() {
        ...
        $.ajax({
            ...
            cache: false,
            beforeSend: function() {
                $("#loading_" + award_id).html("<img src='images/loading.gif' border='0' />");
                $("#err_" + award_id).html("")
            },
            complete: function() {
            ...
            success: function(html) {
                ...
                if (html_split[1] == "OK") {
                    ...
                    $("#li_award_" + award_id).removeClass("award-received");
                    $("#award_receive_" + award_id).addClass("received").html("Đã nhận Item thành công");
                } else {
        ...
        var inptab = $(this).attr("inptab");
         ...
         var dataString = "action=nhanthuong&qindex="+  qindex;
          ...
          $.ajax({
            ...
            cache: false,
            beforeSend: function() {
                 $("#loading_quest_"+ qindex).html("<img src='images/loading.gif' border='0' />");
                 $("#qsuccess").html("");
                 $("#qerror").html("");
            ...
            success: function(html) {
                 ...
                 if(html_split[1] == "OK") {
                    ...
                    $("#head_wcoin").html(html_split[8]);
                    $("#head_pp").html(html_split[9]);
                    
                    $("#box_acc_bank_chao").html(html_split[10]);
                    $("#box_acc_bank_cre").html(html_split[11]);
                    $("#box_acc_bank_blue").html(html_split[12]);
    ...
    $("#btn_pl_change").live('click', function() {
        ...
        if (pl_point_change == 0) {
            $("#plchange_error").html("<div class='form-error'>Điểm Phúc Lợi muốn đổi phải lớn hơn 0.</div>");
        } else {
            ...
            $.ajax({
                ...
                cache: false,
                beforeSend: function() {
                    $("#loading_pl_change").html("<img src='images/loading.gif' border='0' />");
                ...
                success: function(html) {
                    ...
                    if (html_split[1] == "OK") {
                        ...
                        $("#plchange_success").html("<div class='form-success'>" + html_split[3] + "</div>");
                    } else {
                        $("#plchange_error").html("<div class='form-error'>" + html + "</div>");
                    }
    ...
    $("#btn_pl_ban").live('click', function(){
        ...
        var plpoint_gcoin = $("#plpoint_gcoin").val();
        
         var dataString = "action=banpl&plpoint_ban=" + plpoint_ban + "&plpoint_gcoin=" + plpoint_gcoin;
          ...
          $.ajax({
            ...
            cache: false,
            beforeSend: function() {
                 $("#banpl_loading").html("<img src='images/loading.gif' border='0' />");
                 $("#banpl_view").html("");
            ...
            success: function(html) {
                 ...
                 if(html_split[1] == "OK") {
                    ...
                    $("#banpl_view").html("<div class='form-success'>"+ html_split[3] +"</div>");
                    $("#plpoint_ban").val(0);
                    $("#plpoint_gcoin").val(0);
                        
                 } else {
                    $("#banpl_view").html("<div class='form-error'>"+ html +"</div>");
                 }
            }
         });
        return false;
        ...
        var store_id = $(this).attr("store_id");
         ...
         var dataString = "action=muapl&store_id=" + store_id;
          ...
          $.ajax({
            ...
            cache: false,
            beforeSend: function() {
                 $("#muapl_view_" + store_id).html("<img src='images/loading.gif' border='0' />");
            ...
            success: function(html) {
                 ...
                 if(html_split[1] == "OK") {
                    ...
                    $("#muapl_view_" + store_id).html("<div class='form-success'>"+ html_split[2] +"</div>");
                    $("#btn_plmua_" + store_id).val("Đã mua");
                        
                 } else {
                    $("#muapl_view_" + store_id).html("<div class='form-error'>"+ html +"</div>");
        ...
        var store_id = $(this).attr("store_id");
         ...
         var dataString = "action=huyban&store_id=" + store_id;
          ...
          $.ajax({
            ...
            cache: false,
            beforeSend: function() {
                 $("#huypl_view_" + store_id).html("<img src='images/loading.gif' border='0' />");
            ...
            success: function(html) {
                 ...
                 if(html_split[1] == "OK") {
                    ...
                    $("#huypl_view_" + store_id).html("<div class='form-success'>"+ html_split[2] +"</div>");
                    $("#plpoint").html(html_split[3]);
                    $("#td_huyban_" + store_id).html("Đã hủy");
                        
                 } else {
                    $("#huypl_view_" + store_id).html("<div class='form-error'>"+ html +"</div>");
    ...
    function func_rewarditem(vitri) {
        ...
        $.ajax({
            ...
            cache: false,
            beforeSend: function() {
                $("#btn_reward_waiting_" + vitri).html("<img src='images/loading.gif' border='0' />");
            },
            complete: function() {
            ...
            success: function(html) {
                var html_split = html.split("|");
                if (html_split[1] == "OK") {
                    $("#notice_reward_info_" + vitri).html("<div class='form-success'>" + html_split[2] + "</div>");
                    $("#head_gcoin").html(html_split[3]);
                    $("#head_gcoin_km").html(html_split[4]);
                } else {
                    $("#notice_reward_info_" + vitri).html("<div class='form-error'>" + html + "</div>");
                }
            }
        });
        return false;
    ...
    $('.btn_reward').live('click', function() {
        ...
        $.ajax({
            ...
            success: function(html) {
                var html_split = html.split("|");
                if (html_split[1] == "OK") {
                    $("#reward_success_" + vitri).html("<div class='form-success'>" + html_split[2] + "</div>");
                } else {
                    $("#reward_success_" + vitri).html("<div class='form-error'>" + html + "</div>");
                }
            }
        });
        return false;
	...
	//Webshop
    $(".webshop_up").live('click', function() {
        var vitri = $(this).attr('vitri');
        
        $("#webshop_unactive_"+ vitri).slideUp();
        $("#webshop_active_"+ vitri).slideDown();
        
        return false;
    });
    
    $(".webshop_down").live('click', function() {
        var vitri = $(this).attr('vitri');
        
        $("#webshop_unactive_"+ vitri).slideDown();
        $("#webshop_active_"+ vitri).slideUp();
        
        return false;
    });
	
    function func_webshop_exl(vitri) {
		var action = 'webshop';
		var act = $("#shoptype_" + vitri).val();
		var opt = $("#opt_" + vitri).val();
		opt = parseInt(opt);
		var lvl = $("#lvl_" + vitri).val();
		lvl = parseInt(lvl);
        var slg = $("#slg_" + vitri).val();
        slg = parseInt(slg);
        var giagoc = $("#giagoc_" + vitri).val();
        giagoc = parseInt(giagoc);
        var Opt1 = '';
        if ($("#Opt1_" + vitri).is(":checked")) {
            var Opt1 = 0;
        }
        var Opt2 = '';
        if ($("#Opt2_" + vitri).is(":checked")) {
            var Opt2 = 1;
        }
        var Opt3 = '';
        if ($("#Opt3_" + vitri).is(":checked")) {
            var Opt3 = 2;
        }
        var Opt4 = '';
        if ($("#Opt4_" + vitri).is(":checked")) {
            var Opt4 = 3;
        }
        var Opt5 = '';
        if ($("#Opt5_" + vitri).is(":checked")) {
            var Opt5 = 4;
        }		
        var Opt6 = '';
        if ($("#Opt6_" + vitri).is(":checked")) {
            var Opt6 = 5;
        }
        var Opt7 = 0;
        if ($("#Opt7_" + vitri).is(":checked")) {
            var Opt7 = 1;
        }
    ...
    $('.webshop_exl_exl').live('click', function(){
        var vitri = $(this).attr('vitri');
        func_webshop_exl(vitri);
    });
    
    $('.webshop_exl_lvl, .webshop_exl_slg, .webshop_exl_opt').live('change', function(){
        var vitri = $(this).attr('vitri');
        func_webshop_exl(vitri);
    });
	
    $(".webshop").live('click', function() {
        var vitri = $(this).attr('vitri');
		var act = $(this).attr('act');
		var pass2 = $("#pass2_" + vitri).val();
		var opt = $("#opt_" + vitri).val();
		opt = parseInt(opt);
		var lvl = $("#lvl_" + vitri).val();
		lvl = parseInt(lvl);
		...
		if(pass2.length == 0) {
            alert('Chưa nhập mật khẩu web #passweb');
        } else if(slg <= 0) {
            alert('Số lượng item mua phải lớn hơn 0 #slg.');
        } else {
            var dataString = "action=webshop&act="+  act +"&vitri="+  vitri +"&pass2="+ pass2 +"&lvl="+ lvl +"&slg="+ slg +"&Opt1="+ Opt1 +"&Opt2="+ Opt2 +"&Opt3="+ Opt3 +"&Opt4="+ Opt4 +"&Opt5="+ Opt5 +"&Opt6="+ Opt6 +"&Opt7="+ Opt7 +"&opt="+ opt;
             
            $.ajax({
                type: "GET",
                url: "ajax_action.php?ajax=webshop",
                data: dataString,
                cache: false,
                beforeSend: function() {
                     $("#webshop_send_loading_"+ vitri).html("<img src='images/loading.gif' border='0' />");
                     $("#webshop_send_view_"+ vitri).html("");
					 $("#webshop_" + vitri).attr('disabled','disabled');
                },
                complete: function() {
                     $("#webshop_send_loading_"+ vitri).html("");
					 $("#webshop_" + vitri).removeAttr('disabled');
                },
                success: function(html) {
                 var html_split = html.split("|");
                 if(html_split[1] == "OK") {
                        ...
                        $("#webshop_send_view_"+ vitri).html(html);
						$("#webshop_" + vitri).removeAttr('disabled');
                    }
	...
	//Webshop Set
    $(".webshopset_up").live('click', function() {
        var vitri = $(this).attr('vitri');
        
        $("#webshopset_unactive_"+ vitri).slideUp();
        $("#webshopset_active_"+ vitri).slideDown();
        
        return false;
    });
    
    $(".webshopset_down").live('click', function() {
        var vitri = $(this).attr('vitri');
        
        $("#webshopset_unactive_"+ vitri).slideDown();
        $("#webshopset_active_"+ vitri).slideUp();
        
        return false;
    });
	
    function func_webshopset_exl(vitri) {
		var opt = $("#opt_" + vitri).val();
		opt = parseInt(opt);
		var lvl = $("#lvl_" + vitri).val();
		lvl = parseInt(lvl);
    ...
    $('.webshopset_exl_exl').live('click', function(){
        var vitri = $(this).attr('vitri');
        func_webshopset_exl(vitri);
    });
    
    $('.webshopset_exl_lvl, .webshopset_exl_opt').live('change', function(){
        var vitri = $(this).attr('vitri');
        func_webshopset_exl(vitri);
    });
	
    $(".webshopset").live('click', function() {
        var vitri = $(this).attr('vitri');
		var pass2 = $("#pass2_" + vitri).val();
		var opt = $("#opt_" + vitri).val();
		opt = parseInt(opt);
		...
		if(pass2.length == 0) {
            alert('Chưa nhập mật khẩu web');
        } else {
            var dataString = "action=webshopset&vitri="+ vitri +"&pass2="+ pass2 +"&lvl="+ lvl +"&Opt1="+ Opt1 +"&Opt2="+ Opt2 +"&Opt3="+ Opt3 +"&Opt4="+ Opt4 +"&Opt5="+ Opt5 +"&Opt6="+ Opt6 +"&Opt7="+ Opt7 +"&opt="+ opt;
             
            $.ajax({
                type: "GET",
                url: "ajax_action.php?ajax=webshopset",
                data: dataString,
                cache: false,
                beforeSend: function() {
                     $("#webshopset_send_loading_"+ vitri).html("<img src='images/loading.gif' border='0' />");
                     $("#webshopset_send_view_"+ vitri).html("");
					 $("#webshopset_" + vitri).attr('disabled','disabled');
                },
                complete: function() {
                     $("#webshopset_send_loading_"+ vitri).html("");
					 $("#webshopset_" + vitri).removeAttr('disabled');
                },
                success: function(html) {
                 var html_split = html.split("|");
                 if(html_split[1] == "OK") {
                        ...
                        $("#webshopset_send_view_"+ vitri).html(html);
						$("#webshopset_" + vitri).removeAttr('disabled');
                    }
	...
	//WebshopKC
    function func_webshopkc_exl(vitri) {
		var action = 'webshopkc';
		var act = $("#shoptype_" + vitri).val();
		var opt = $("#opt_" + vitri).val();
		opt = parseInt(opt);
		var lvl = $("#lvl_" + vitri).val();
    ...
    $('.webshopkc_exl_exl').live('click', function(){
        var vitri = $(this).attr('vitri');
        func_webshopkc_exl(vitri);
    });
    
    $('.webshopkc_exl_lvl, .webshopkc_exl_slg, .webshopkc_exl_opt').live('change', function(){
        var vitri = $(this).attr('vitri');
        func_webshopkc_exl(vitri);
    });
	
    $(".webshopkc").live('click', function() {
        var vitri = $(this).attr('vitri');
		var act = $(this).attr('act');
		var pass2 = $("#pass2_" + vitri).val();
		var opt = $("#opt_" + vitri).val();
		...
		if(pass2.length == 0) {
            ...
            var dataString = "action=webshopkc&act="+  act +"&vitri="+  vitri +"&pass2="+ pass2 +"&lvl="+ lvl +"&slg="+ slg +"&Opt1="+ Opt1 +"&Opt2="+ Opt2 +"&Opt3="+ Opt3 +"&Opt4="+ Opt4 +"&Opt5="+ Opt5 +"&Opt6="+ Opt6 +"&Opt7="+ Opt7 +"&opt="+ opt;
            ...
            $.ajax({
                ...
                cache: false,
                beforeSend: function() {
                     $("#webshopkc_send_loading_"+ vitri).html("<img src='images/loading.gif' border='0' />");
                     $("#webshopkc_send_view_"+ vitri).html("");
					 $("#webshopkc_" + vitri).attr('disabled','disabled');
                },
                complete: function() {
                     $("#webshopkc_send_loading_"+ vitri).html("");
					 $("#webshopkc_" + vitri).removeAttr('disabled');
                },
                success: function(html) {
                 var html_split = html.split("|");
                 if(html_split[1] == "OK") {
                        ...
                        $("#webshopkc_send_view_"+ vitri).html(html);
						$("#webshopkc_" + vitri).removeAttr('disabled');
                    }
	...
	//Webshop Set KC
    function func_webshopsetkc_exl(vitri) {
		var action = 'webshopsetkc'
		var opt = $("#opt_" + vitri).val();
		opt = parseInt(opt);
		var lvl = $("#lvl_" + vitri).val();
		lvl = parseInt(lvl);
    ...
    $('.webshopsetkc_exl_exl').live('click', function(){
        var vitri = $(this).attr('vitri');
        func_webshopsetkc_exl(vitri);
    });
    
    $('.webshopsetkc_exl_lvl, .webshopsetkc_exl_opt').live('change', function(){
        var vitri = $(this).attr('vitri');
        func_webshopsetkc_exl(vitri);
    });
	
    $(".webshopsetkc").live('click', function() {
        var vitri = $(this).attr('vitri');
		var pass2 = $("#pass2_" + vitri).val();
		var opt = $("#opt_" + vitri).val();
		opt = parseInt(opt);
		...
		if(pass2.length == 0) {
            ...
            var dataString = "action=webshopsetkc&vitri="+ vitri +"&pass2="+ pass2 +"&lvl="+ lvl +"&Opt1="+ Opt1 +"&Opt2="+ Opt2 +"&Opt3="+ Opt3 +"&Opt4="+ Opt4 +"&Opt5="+ Opt5 +"&Opt6="+ Opt6 +"&Opt7="+ Opt7 +"&opt="+ opt;
            ...
            $.ajax({
                ...
                cache: false,
                beforeSend: function() {
                     $("#webshopsetkc_send_loading_"+ vitri).html("<img src='images/loading.gif' border='0' />");
                     $("#webshopsetkc_send_view_"+ vitri).html("");
					 $("#webshopsetkc_" + vitri).attr('disabled','disabled');
                },
                complete: function() {
                     $("#webshopsetkc_send_loading_"+ vitri).html("");
					 $("#webshopsetkc_" + vitri).removeAttr('disabled');
                },
                success: function(html) {
                 var html_split = html.split("|");
                 if(html_split[1] == "OK") {
                        ...
                        $("#webshopsetkc_send_view_"+ vitri).html(html);
						$("#webshopsetkc_" + vitri).removeAttr('disabled');
                    }
    ...
    $('#xoay_longcondor').live('click', function() {
        ...
        $.ajax({
            ...
            cache: false,
            beforeSend: function() {
                $("#xoay_longcondor_msg").html("<img src='images/loading.gif' border='0' />");
            },
            complete: function() {},
            success: function(html) {
                var html_split = html.split("|");
                if (html_split[1] == "OK") {
                    if (html_split[2] == 1) {
                        $("#xoay_longcondor_info").html("<div class='form-success'>" + html_split[3] + "</div>");
                        $("#xoay_longcondor_msg").html("");
                    } else if (html_split[2] == 2) {
                        $("#xoay_longcondor_info").html("<div class='form-error'>" + html_split[3] + "</div>");
                        $("#xoay_longcondor_msg").html("");
                    } else {
                        $("#xoay_longcondor_msg").html("<div class='form-success'>" + html_split[3] + "</div>");
                    }
                } else {
                    $("#xoay_longcondor_msg").html("<div class='form-error'>" + html + "</div>");
                }
            }
        });
        return false;
    });
    $('#trader_quay').live('click', function() {
        var item = $(this).attr('item');
        var tyle = $(this).attr('tyle');
        var dataString = "action=trader_quay&item=" + item + "&tyle=" + tyle;
        $.ajax({
            type: "GET",
            url: "ajax_action.php?ajax=maychaos",
            data: dataString,
            cache: false,
            beforeSend: function() {
                $("#trader_quay_msg").html("<img src='images/loading.gif' border='0' />");
            },
            complete: function() {},
            success: function(html) {
                var html_split = html.split("|");
                if (html_split[1] == "OK") {
                    if (html_split[2] == 1) {
                        $("#trader_quay_info").html("<div class='form-success'>" + html_split[3] + "</div>");
                        $("#trader_quay_msg").html("");
                    } else if (html_split[2] == 2) {
                        $("#trader_quay_info").html("<div class='form-error'>" + html_split[3] + "</div>");
                        $("#trader_quay_msg").html("");
                    } else {
                        $("#trader_quay_msg").html("<div class='form-success'>" + html_split[3] + "</div>");
                    }
                } else {
                    $("#trader_quay_msg").html("<div class='form-error'>" + html + "</div>");
                }
            }
        });
        return false;
    ...
    $('#kickket').live('click', function() {
        ...
        $.ajax({
            ...
            cache: false,
            beforeSend: function() {
                $("#kickket_msg").html("<img src='images/loading.gif' border='0' />");
            },
            complete: function() {},
            success: function(html) {
                if (html == 'OK') {
                    $("#kickket_msg").html("<div class='form-success'>Đã gửi thông tin Kích Kẹt. Bạn vui lòng đợi trong 5 giây rồi vào Game.</div>");
                } else {
                    $("#kickket_msg").html("<div class='form-error'>" + html + "</div>");
                }
            }
        });
        return false;
    });
    $('input[name=money_type]').live('click', function() {
    ...
    $('#relax_lo_danh').live('click', function() {
        ...
        $.ajax({
            ...
            cache: false,
            beforeSend: function() {
                $("#lo_msg").html("<img src='images/loading.gif' border='0' />");
            ...
            success: function(html) {
                var html_split = html.split("|");
                if (html_split[1] == 'OK') {
                    $("#lo_msg").html("<div class='form-success'>Đã đánh " + lo_diem + " điểm lô con " + lo_so + ".<br />Chúc bạn may mắn.</div>");
                    if (money_type == 2) {
                    ...
                    $("#lo_msg").html("<div class='form-error'>" + html + "</div>");
                }
    ...
    $('#btn_lo_history').live('click', function() {
        ...
        $.ajax({
            ...
            cache: false,
            beforeSend: function() {
                $("#lo_history").html("<img src='images/loading.gif' border='0' />");
            },
            complete: function() {},
            success: function(html) {
    ...
    $('input[name=money_type_de]').live('click', function() {
    ...
    $('#relax_de_danh').live('click', function() {
        ...
        $.ajax({
            ...
            cache: false,
            beforeSend: function() {
                $("#de_msg").html("<img src='images/loading.gif' border='0' />");
            ...
            success: function(html) {
                ...
                if (html_split[1] == 'OK') {
                    ...
                    $("#de_msg").html("<div class='form-success'>Đã đánh " + de_diem + ".000 " + money_name + " đề con " + de_so + ".<br />Chúc bạn may mắn.</div>");
                    $("#de_so").val(0);
                    $("#de_diem").val(0);
                } else {
                    $("#de_msg").html("<div class='form-error'>" + html + "</div>");
                }
    ...
    $('#btn_de_history').live('click', function() {
        ...
        $.ajax({
            ...
            cache: false,
            beforeSend: function() {
                $("#de_history").html("<img src='images/loading.gif' border='0' />");
            },
            complete: function() {},
            success: function(html) {
    ...
    $('.danhhieu_choise').live('click', function() {
        ...
        $.ajax({
            ...
            cache: false,
            beforeSend: function() {
                $("#msg_" + danhhieu_type + "_" + danhhieu_id).html("<img src='images/loading.gif' border='0' />");
            ...
            success: function(html) {
                if (html == 'OK') {
                    ...
                    $("#danhhieu_col_" + danhhieu_type + "_" + danhhieu_id).html("<font color='red'>Đã kích hoạt.<br />Hãy đổi nhân vật trong Game để có hiệu lực.</font>");
                } else {
    ...
    $('.event2_doi').live('click', function() {
        ...
        $.ajax({
            ...
            cache: false,
            beforeSend: function() {
                $("#loading_btn_event2_doi_" + event_type + "_" + phuongthuc).html("<img src='images/loading.gif' border='0' />");
	...
	//*Begin warehousesafe*/
    $(".warehouse_up").live('click', function() {
        var vitri = $(this).attr('vitri');
		$("#warehouse_unactive_"+ vitri).slideUp();
        $("#warehouse_active_" + vitri).slideDown();
        return false;
    });
    $(".warehouse_down").live('click', function() {
        var vitri = $(this).attr('vitri');
        $("#warehouse_active_" + vitri).slideUp();
		$("#warehouse_unactive_"+ vitri).slideDown();
        return false;
    });
	
    $(".warehouse_move").live('click', function() {
        var warehouse_type = $(this).attr("warehouse_type"); /* 0 : WareHouse | 1 : WareHouse safe */
        ...
        $.ajax({
            type: "GET",
            url: "ajax_action.php?ajax=warehousesafe",
            data: dataString,
            cache: false,
            beforeSend: function() {
                $(".warehouse_move").removeClass("warehouse_move").addClass("warehouse_moving");
                $("#" + itemcode + key).html("<img src='images/loading.gif' border='0' />");
            },
            complete: function() {
                $("#" + itemcode + key).html("");
            },
            success: function(html) {
                ...
                if (html_split[1] == "OK") {
                    if (warehouse_type == '0') {
                        ...
                        $(".warehouse_move[itemcode=" + itemcode + "][key=" + key + "]").appendTo("#warehouse_safe_list");
                        $("#item_in_warehouse_safe").html(html_split[3]);
                        $("#menu_warehouse_safe_item").html(html_split[3]);
                        if (html_split[4] == '0') {
                        ...
                        $("#item_in_warehouse_safe").html(html_split[2]);
                        $("#menu_warehouse_safe_item").html(html_split[2]);
                        if (html_split[3] == '0') {
                            $("#acc_note").removeClass();
                        } else {
                            $("#acc_note").addClass("note-evt");
                    ...
                    _showPopup('Hòm Đồ An Toàn', '<span class=\'color-red\'>' + html + '</span>');
                }
            }
        });
        return false;
    ...
    $("#warehouse_extra").live('click', function(){
        var dataString = "action=warehouse_extra";
        var r = confirm("Bạn đang thực hiện mua thêm vị trí items trên Hòm Đồ Ảo!\nBạn có chắc chắn thao tác của mình là đúng?\nNếu đúng hãy bấm OK để tiếp tục hoặc bấm Cancel để xem xét lại.");
		if(r == true){
			$.ajax({
            type: "GET",
            url: "ajax_action.php?ajax=warehousesafe",
            ...
            cache: false,
            beforeSend: function() {
                 $("#warehouse_extra_loading").html("<img src='images/loading.gif' border='0' />");
            },
            complete: function() {
                 $("#warehouse_extra_loading").html("");
            },
            success: function(html) {
                 var html_split = html.split("|");
                 
                 if(html_split[1] == "OK") {
                    $("#menu_warehouse_secure_slot").html(html_split[2]);
                    $("#page_warehouse_secure_slot").html(html_split[2]);
	...
	/* gia han */
	$(".retimeitem_up").live('click', function() {
        var vitri = $(this).attr('vitri');  
        $("#retimeitem_unactive_"+ vitri).slideUp();
        $("#retimeitem_active_"+ vitri).slideDown();
        return false;
    });
	$(".retimeitem_down").live('click', function() {
        var vitri = $(this).attr('vitri');
        
        $("#retimeitem_unactive_"+ vitri).slideDown();
        $("#retimeitem_active_"+ vitri).slideUp();
        
        return false;
    });
	
	$(".retimeitem_send").live('click', function() {
        var vitri = $(this).attr('vitri');
        var item_code = $(this).attr('item_code');
        var retimeitemday = $("#retimeitemday_"+ vitri).val();
            retimeitemday = parseInt(retimeitemday);
        var pass2 = $("#pass2_" + vitri).val();  
		
		if(item_code.length != 32) {
            alert('Item Code sai');
        }else if(retimeitemday<1){
			alert('Ngày gia hạn phải lớn hơn 1');
		}else if(pass2.length==0){
			alert('Vui lòng nhập mật khẩu cấp 2');
		}
		else {
            var dataString = "action=RetimeItem&vitri="+  vitri +"&item_code="+ item_code +"&pass2="+ pass2 +"&retimeitemday="+ retimeitemday +"&GiaHan=1";
            $.ajax({
                type: "GET",
                url: "ajax_action.php?ajax=item_giahan",
                data: dataString,
                cache: false,
                beforeSend: function() {
                     $("#retimeitem_send_loading_"+ vitri).html("<img src='images/loading.gif' border='0' />");
                     $("#retimeitem_send_view_"+ vitri).html("");
                },
                complete: function() {
				...
				success: function(html) {
					 var html_split = html.split("|");
					 if(html_split[1] == "OK") {
					   $("#retimeitem_send_loading_"+ vitri).html("<div class='success'>"+ html_split[2] +"</div>");
						
					 } else {
						 $("#retimeitem_send_loading_"+ vitri).html("<div class='error'>"+ html +"</div>");
					 }	  
	...
	$(".type").live('click', function() {
        var typeid = $('#type').val();
		if(typeid.length==0){
			$("#type_play").html('<input type=text name=num_bet1 id=num_bet1 size=3 maxlength=2 class="form-style num_bet1" style=width:25px/>');
		}
        else if(typeid=='lo'||typeid=='de'){
			$("#type_play").html('<input type=text name=num_bet1 id=num_bet1 size=3 maxlength=2 class="form-style num_bet1" style=width:25px/>');
		}else if(typeid=='loxien2'){
			$("#type_play").html('<input type="text" name="num_bet1" id="num_bet1" size="3" maxlength="2" class="num_bet1" style="width:45px"/> <input type="text" name="num_bet2" id="num_bet2" size="3" maxlength="2" class="num_bet2" style="width:45px"/>');
		}else if(typeid=='loxien3'){
			$("#type_play").html('<input type="text" name="num_bet1" id="num_bet1" size="3" maxlength="2" class="num_bet1" style="width:45px"/> <input type="text" name="num_bet2" id="num_bet2" size="3" maxlength="2" class="num_bet2" style="width:45px"/> <input type="text" name="num_bet3" id="num_bet3" size="3" maxlength="2" class="num_bet3" style="width:45px"/>');
		}else if(typeid=='loxien4'){
			$("#type_play").html('<input tye="text" name="num_bet1" id="num_bet1" size="3" maxlength="2" class="num_bet1" style="width:45px"/> <input type="text" name="num_bet2" id="num_bet2" size="3" maxlength="2" class="num_bet2" style="width:45px"/> <input type="text" name="num_bet3" id="num_bet3" size="3" maxlength="2" class="num_bet3" style="width:45px"/> <input type="text" name="num_bet4" id="num_bet4" size="3" maxlength="2" class="num_bet4" style="width:45px"/>');
		}
        return false;
    });
	$(".lode_ghiso").live('click', function(){
		var typeplay = $('.type').val();
		var type_money = $('.type_money').val();
		var num_bet1,num_bet2,num_bet3,num_bet4;
		if(typeplay=='lo'||typeplay=='de'){
			num_bet1=parseInt($('#num_bet1').val());
			num_bet2=0;num_bet3=0,num_bet4=0;
			$typeplayshow ='Đánh Đề';
		 }else if(typeplay=='loxien2'){
			num_bet1=parseInt($('#num_bet1').val());
			num_bet2=parseInt($('#num_bet2').val());
			num_bet3=0,num_bet4=0;
			$typeplayshow ='Đánh Lô Xiên 2';
		 }else if(typeplay=='loxien3'){
			num_bet1=parseInt($('#num_bet1').val());
			num_bet2=parseInt($('#num_bet2').val());
			num_bet3=parseInt($('#num_bet3').val());
			num_bet4=0;
			$typeplayshow ='Đánh Lô Xiên 3';
		 }else if(typeplay=='loxien4'){
			num_bet1=parseInt($('#num_bet1').val());
			num_bet2=parseInt($('#num_bet2').val());
			num_bet3=parseInt($('#num_bet3').val());
			num_bet4=parseInt($('#num_bet4').val());	
			$typeplayshow ='Đánh Lô Xiên 4';
		 }
		var num_point = parseInt($('#num_point').val());	
		
		var Datavweb = "action=Play_Lode&typeplay="+ typeplay +"&num_bet1="+ num_bet1 +"&num_bet2="+ num_bet2 +"&num_bet3="+ num_bet3 +"&num_bet4="+ num_bet4 +"&num_point="+ num_point +"&type_money="+ type_money;
		$.ajax({
			type: "GET",
			url: "ajax_action.php?ajax=lode_vweb",
			data: Datavweb,
			cache: false,
			beforeSend: function() {
				$("#loading_lode").html("<img src='images/loading.gif' border='0' />");
				$("#err_loading_lode").html("")
			},
			complete: function() {
                 $("#loading_lode").html("");
            },
			success: function(html) {
                 ...
                 if(html_split[1] == "OK") {
					var NumBetShow='';
					if(num_bet1!='0') NumBetShow+=" "+num_bet1;
					if(num_bet2!='0') NumBetShow+=" "+num_bet2;
					if(num_bet3!='0') NumBetShow+=" "+num_bet3;
					if(num_bet4!='0') NumBetShow+=" "+num_bet4;
                    $ContentShow = "Bạn đã ghi số "+NumBetShow+" Loại chơi: "+$typeplayshow +" Số điểm cược: "+num_point+" "+type_money+" chúc bạn may mắn. <br />Bạn hãy chờ kết quả lúc 19h00 hằng ngày";
                    Dialog($ContentShow);
                 } else {
                     Dialog(html);
                 }	  
	...
	$("#check_bet").live('click', function(){
		var lode_id=$(this).attr('lode_id');
		var datebet_id=$(this).attr('datebet_id');
		var Datavweb = "action=CheckBet&lode_id="+ lode_id;
		$.ajax({
			type: "GET",
			url: "ajax_action.php?ajax=lode_vweb",
			data: Datavweb,
			...
			success: function(html) {
                 ...
                 if(html_split[1] == "OK") {
                    Dialog(html_split[2]);
					$("#load_content").load("index2.php?mod=relax&act=ketqua&date_bet="+ datebet_id);
                 } else {
                     Dialog(html);
                 }	  
    ...
    $("#btn_upgradevip").live('click', function() {
        ...
        $.ajax({
            ...
            cache: false,
            beforeSend: function() {
                $("#uv_loading").html("<img src='images/loading.gif' border='0' />");
                $("#uv_err").html("");
            ...
            success: function(html) {
                var html_split = html.split("|");
                if (html_split[1] == "OK") {
                    $("#uv_content").html("<div class='form-success'>" + html_split[2] + "</div>");
                } else {
                    $("#uv_err").html("<div class='form-error'>" + html + "</div>");
                }
    ...
    $("#btn_vip_receivepl").live('click', function() {
        ...
        $.ajax({
            ...
            success: function(html) {
                ...
                if (html_split[1] == "OK") {
                    ...
                    $("#uv_content").html("<div class='form-error'>" + html + "</div>");
    ...
    $('#btn_vipvweb_buy').live('click', function(){
        var vip_period = $('#vip_period').val();
		var buy_vip_type = $('#buy_vip_type').val();
		var character = $('input[name=character]').val();
		var pass2 = $('input[name=pass2]').val();
        var dataString = "action=vipvweb&vip_period="+ vip_period +"&character="+ character +"&pass2="+ pass2 +"&buy_vip_type="+ buy_vip_type;
        var r = confirm("Bạn đang thực hiện đăng ký VIP cho tài khoản!\nBạn có chắc chắn thao tác của mình là đúng?\nNếu đúng hãy bấm OK để tiếp tục hoặc bấm Cancel để xem xét lại.");
		if(r == true){
        $.ajax({
            type: "GET",
            url: "ajax_action.php?ajax=vipvweb",
            data: dataString,
            cache: false,
            beforeSend: function() {
                 $("#msg_vipvweb").html("<img src='images/loading.gif' border='0' />");
                 $("#vipvweb_buy").attr('disabled','disabled');
            },
            complete: function() {
            ...
            success: function(html) {
                var html_split = html.split("<vweb>");
                if(html_split[1] == "OK") {
                    $("#msg_vipvweb").html("<div class='form-success'>" + html_split[2] + "</div>");
                    $("#vipvweb_buy").removeAttr('disabled');
					
					$("#head_gcoin").html(html_split[3]);
                    } else {
                    $("#msg_vipvweb").html("<div class='form-error'>" + html + "</div>");
                    $("#vipvweb_buy").removeAttr('disabled');
                }
            }
         });
    ...
    $("select").live('change', function() {
		var svvip_choise = $("#svvip_choise").val();
		svvip_choise = parseInt(svvip_choise);
		var viplv_choise = $("#viplv_choise").val();
		viplv_choise = parseInt(viplv_choise);
        $.get("ajax_action.php", {
            ajax: "svvip_view",
            isvvip_choise: svvip_choise,
			iviplv_choise: viplv_choise
        }, function(data) {
            $("#sumvip").html(data);
        });
    });
	
    $('#btn_svvip_buy').live('click', function(){
        var svvip_choise = $('#svvip_choise').val();
		var viplv_choise = $('#viplv_choise').val();
		var pass2 = $('input[name=pass2]').val();
        var dataString = "action=svvip_choise&svvip_choise="+ svvip_choise +"&viplv_choise="+ viplv_choise +"&pass2="+ pass2;
        var r = confirm("Bạn đang thực hiện đăng ký Server VIP!\nBạn có chắc chắn thao tác của mình là đúng?\nNếu đúng hãy bấm OK để tiếp tục hoặc bấm Cancel để xem xét lại.");
		if(r == true){
        $.ajax({
            type: "GET",
            url: "ajax_action.php?ajax=svvip",
            data: dataString,
            cache: false,
            beforeSend: function() {
                 $("#msg_svvip").html("<img src='images/loading.gif' border='0' />");
                 $("#svvip_buy").attr('disabled','disabled');
            },
            complete: function() {
            ...
            success: function(html) {
                var html_split = html.split("<vweb>");
                if(html_split[1] == "OK") {
                    $("#msg_svvip").html("<div class='form-success'>" + html_split[2] + "</div>");
                    $("#svvip_buy").removeAttr('disabled');
                    
                    $("#head_gcoin").html(html_split[3]);
                } else {
                    $("#msg_svvip").html("<div class='form-error'>" + html + "</div>");
                    $("#svvip_buy").removeAttr('disabled');
                }
            }
         });
    ...
    $('#btn_buats_buy').live('click', function(){
        var buats_choise = $('#buats_choise').val();
		var pass2 = $('input[name=pass2]').val();
        var dataString = "action=buats_choise&buats_choise="+ buats_choise +"&pass2="+ pass2;
        var r = confirm("Bạn đang thực hiện mua Bùa Thiên Sứ!\nBạn có chắc chắn thao tác của mình là đúng?\nNếu đúng hãy bấm OK để tiếp tục hoặc bấm Cancel để xem xét lại.");
		if(r == true){
        $.ajax({
            type: "GET",
            url: "ajax_action.php?ajax=char_buats",
            data: dataString,
            cache: false,
            beforeSend: function() {
                 $("#msg_buats").html("<img src='images/loading.gif' border='0' />");
                 $("#buats_buy").attr('disabled','disabled');
            },
            complete: function() {
            ...
            success: function(html) {
                var html_split = html.split("<vweb>");
                if(html_split[1] == "OK") {
                    $("#msg_buats").html("<div class='form-success'>" + html_split[2] + "</div>");
                    $("#buats_buy").removeAttr('disabled');
                    
                    $("#head_gcoin").html(html_split[3]);
                } else {
                    $("#msg_buats").html("<div class='form-error'>" + html + "</div>");
                    $("#buats_buy").removeAttr('disabled');
                }
            }
         });
    ...
    $('#btn_buass2_buy').live('click', function(){
        var buass2_choise = $('#buass2_choise').val();
		var bua_day_choise = $('#bua_day_choise').val();
		var pass2 = $('input[name=pass2]').val();
        var dataString = "action=buass2_choise&buass2_choise="+ buass2_choise +"&bua_day_choise="+ bua_day_choise +"&pass2="+ pass2;
        var r = confirm("Bạn đang thực hiện mua Bùa!\nBạn có chắc chắn thao tác của mình là đúng?\nNếu đúng hãy bấm OK để tiếp tục hoặc bấm Cancel để xem xét lại.");
		if(r == true){
        $.ajax({
            type: "GET",
            url: "ajax_action.php?ajax=char_buass2",
            data: dataString,
            cache: false,
            beforeSend: function() {
                 $("#msg_buass2").html("<img src='images/loading.gif' border='0' />");
                 $("#buass2_buy").attr('disabled','disabled');
            },
            complete: function() {
            ...
            success: function(html) {
                var html_split = html.split("<vweb>");
                if(html_split[1] == "OK") {
                    $("#msg_buass2").html("<div class='form-success'>" + html_split[2] + "</div>");
                    $("#buass2_buy").removeAttr('disabled');
                    
                    $("#head_gcoin").html(html_split[3]);
                } else {
                    $("#msg_buass2").html("<div class='form-error'>" + html + "</div>");
                    $("#buass2_buy").removeAttr('disabled');
                }
            }
         });
    ...
    $('#btn_spin_buy').live('click', function(){
        var money_type = $('#money_type').val();
		var pass2 = $('input[name=pass2]').val();
		var spinnumber = $('input[name=spinnumber]').val();
        var dataString = "action=spin_paid&money_type="+ money_type +"&pass2="+ pass2 +"&spinnumber="+ spinnumber;
        var r = confirm("Bạn đang thực hiện mua số Lần Quay!\nBạn có chắc chắn thao tác của mình là đúng?\nNếu đúng hãy bấm OK để tiếp tục hoặc bấm Cancel để xem xét lại.");
		if(r == true){
        $.ajax({
            type: "GET",
            url: "ajax_action.php?ajax=vongquay",
            data: dataString,
            cache: false,
            beforeSend: function() {
                 $("#msg_spin").html("<img src='images/loading.gif' border='0' />");
                 $("#spin_buy").attr('disabled','disabled');
            },
            complete: function() {
            ...
            success: function(html) {
                var html_split = html.split("<vweb>");
                if(html_split[1] == "OK") {
                    $("#msg_spin").html("<div class='form-success'>" + html_split[2] + "</div>");
                    $("#spin_buy").removeAttr('disabled');
                } else {
                    $("#msg_spin").html("<div class='form-error'>" + html + "</div>");
                    $("#spin_buy").removeAttr('disabled');
                }
            }
         });
    ...
    $('#btn_relife2kimcuong').live('click', function(){
		var pass2 = $('input[name=pass2]').val();
        var dataString = "action=relife2kimcuong&pass2="+ pass2;
        var r = confirm("Bạn đang thực hiện mua Đổi Relifes sang Kim Cương!\nBạn có chắc chắn thao tác của mình là đúng?\nNếu đúng hãy bấm OK để tiếp tục hoặc bấm Cancel để xem xét lại.");
		if(r == true){
        $.ajax({
            type: "GET",
            url: "ajax_action.php?ajax=relife2kimcuong",
            data: dataString,
            cache: false,
            beforeSend: function() {
                 $("#msg_relife2kimcuong").html("<img src='images/loading.gif' border='0' />");
                 $("#relife2kimcuong").attr('disabled','disabled');
            },
            complete: function() {
            ...
            success: function(html) {
                var html_split = html.split("<vweb>");
                if(html_split[1] == "OK") {
                    $("#msg_relife2kimcuong").html("<div class='form-success'>" + html_split[2] + "</div>");
                    $("#relife2kimcuong").removeAttr('disabled');
                    
                } else {
                    $("#msg_relife2kimcuong").html("<div class='form-error'>" + html + "</div>");
                    $("#relife2kimcuong").removeAttr('disabled');
                }
            }
         });
    ...
    $('#btn_master2point').live('click', function(){
		var pass2 = $('input[name=pass2]').val();
        var dataString = "action=master2point&pass2="+ pass2;
        var r = confirm("Bạn đang thực hiện mua Đổi Master sang Point!\nBạn có chắc chắn thao tác của mình là đúng?\nNếu đúng hãy bấm OK để tiếp tục hoặc bấm Cancel để xem xét lại.");
		if(r == true){
        $.ajax({
            type: "GET",
            url: "ajax_action.php?ajax=master2point",
            data: dataString,
            cache: false,
            beforeSend: function() {
                 $("#msg_master2point").html("<img src='images/loading.gif' border='0' />");
                 $("#master2point").attr('disabled','disabled');
            },
            complete: function() {
            ...
            success: function(html) {
                var html_split = html.split("<vweb>");
                if(html_split[1] == "OK") {
                    $("#msg_master2point").html("<div class='col-sm-12'><div class='alert fade alert-simple alert-success alert-dismissible text-left font__family-montserrat font__size-16 font__weight-light brk-library-rendered rendered show'> <button type='button' class='close font__size-18' data-dismiss='alert'><span aria-hidden='true'><a href='https://www.youtube.com/watch?v=_XiOcsj3oNI&t=50s' target='_blank'><i class='fa fa-times greencross'></i></a></span><span class='sr-only'>Close</span> </button><i class='start-icon far fa-check-circle faa-tada animated'></i><strong class='font__weight-semibold'>" + html_split[2] + "</strong></div></div>");
                    $("#master2point").removeAttr('disabled');
                    
                } else {
                    $("#msg_master2point").html("<div class='col-sm-12'><div class='alert fade alert-simple alert-danger alert-dismissible text-left font__family-montserrat font__size-16 font__weight-light brk-library-rendered rendered show' role='alert' data-brk-library='component__alert'><button type='button' class='close font__size-18' data-dismiss='alert'><span aria-hidden='true'><i class='fa fa-times danger '></i></span><span class='sr-only'>Close</span></button><i class='start-icon far fa-times-circle faa-pulse animated'></i><strong class='font__weight-semibold'>" + html + "</strong></div></div>");
                    $("#master2point").removeAttr('disabled');
                }
            }
         });
    ...
    $('#btn_master2goblinpoint').live('click', function(){
		var character = $('input[name=character]').val();
		var point_doi = $('input[name=point_doi]').val();
        var dataString = "action=master2goblinpoint&character="+ character +"&point_doi="+ point_doi;
        var r = confirm("Bạn đang thực hiện mua Đổi Master sang GoblinPoint!\nBạn có chắc chắn thao tác của mình là đúng?\nNếu đúng hãy bấm OK để tiếp tục hoặc bấm Cancel để xem xét lại.");
		if(r == true){
        $.ajax({
            type: "GET",
            url: "ajax_action.php?ajax=master2goblinpoint",
            data: dataString,
            cache: false,
            beforeSend: function() {
                 $("#msg_master2goblinpoint").html("<img src='images/loading.gif' border='0' />");
                 $("#master2goblinpoint").attr('disabled','disabled');
            },
            complete: function() {
            ...
            success: function(html) {
                var html_split = html.split("<vweb>");
                if(html_split[1] == "OK") {
                    $("#msg_master2goblinpoint").html("<div class='form-success'>" + html_split[1] + "</div>");
                    $("#master2goblinpoint").removeAttr('disabled');
                    
                } else {
                    $("#msg_master2goblinpoint").html("<div class='form-error'>" + html + "</div>");
                    $("#master2goblinpoint").removeAttr('disabled');
                }
            }
         });
    ...
    $('#btn_muathenap').live('click', function(){
        var loaithe = $('#loaithe').val();
		var menhgia = $('#menhgia').val();
		var slg = $('#slg').val();
        var dataString = "action=muathenap&loaithe="+ loaithe +"&menhgia="+ menhgia +"&slg="+ slg;
        var r = confirm("Bạn đang thực hiện mua thẻ nạp từ Gcoin!\nBạn có chắc chắn thao tác của mình là đúng?\nNếu đúng hãy bấm OK để tiếp tục hoặc bấm Cancel để xem xét lại.");
		if(r == true){
        $.ajax({
            type: "GET",
            url: "ajax_action.php?ajax=muathenap",
            data: dataString,
            cache: false,
            beforeSend: function() {
                 $("#msg_muathenap").html("<img src='images/loading.gif' border='0' />");
                 $("#muathenap_buy").attr('disabled','disabled');
            },
            complete: function() {
            ...
            success: function(html) {
                var html_split = html.split("<vweb>");
                if(html_split[1] == "OK") {
                    $("#msg_muathenap").html("<div class='form-success'>" + html_split[2] + "</div>");
                    $("#muathenap_buy").removeAttr('disabled');
					
					$("#head_gcoin").html(html_split[3]);
                    } else {
                    $("#msg_muathenap").html("<div class='form-error'>" + html + "</div>");
                    $("#muathenap_buy").removeAttr('disabled');
                }
            }
         });
    ...
    $('#btn_napthe').live('click', function(){
		var act = $('#loaithe').val();
		var menhgia = $('#menhgia').val();
		var card_num = $('#card_num').val();
		var card_serial = $('#card_serial').val();
        var dataString = "action=napthe&act="+ act +"&menhgia="+ menhgia +"&card_num="+ card_num +"&card_serial="+ card_serial;
        var r = confirm("Bạn đang thực hiện nạp thẻ!\nBạn có chắc chắn thao tác của mình là đúng?\nNếu đúng hãy bấm OK để tiếp tục hoặc bấm Cancel để xem xét lại.");
		if(r == true){
        $.ajax({
            type: "GET",
            url: "ajax_action.php?ajax=napthe",
            data: dataString,
            cache: false,
            beforeSend: function() {
                 $("#msg_napthe").html("<img src='images/loading.gif' border='0' />");
                 $("#napthe_buy").attr('disabled','disabled');
            },
            complete: function() {
            ...
            success: function(html) {
                var html_split = html.split("<vweb>");
                if(html_split[1] == "OK") {
                    $("#msg_napthe").html("<div class='col-sm-12'><div class='alert fade alert-simple alert-success alert-dismissible text-left font__family-montserrat font__size-16 font__weight-light brk-library-rendered rendered show'> <button type='button' class='close font__size-18' data-dismiss='alert'><span aria-hidden='true'><a href='https://www.youtube.com/watch?v=_XiOcsj3oNI&t=50s' target='_blank'><i class='fa fa-times greencross'></i></a></span><span class='sr-only'>Close</span> </button><i class='start-icon far fa-check-circle faa-tada animated'></i><strong class='font__weight-semibold'>" + html_split[2] + "</strong></div></div>");
                    $("#napthe_buy").removeAttr('disabled');
    ...
    $('#btn_moddaily_xuly').live('click', function(){
        var option = $('#option').val();
		var name_option = $('input[name=name_option]').val();
		var giatri_plus = $('input[name=giatri_plus]').val();
		var pass2 = $('input[name=pass2]').val();
        var dataString = "action=moddaily&option="+ option +"&name_option="+ name_option +"&giatri_plus="+ giatri_plus +"&pass2="+ pass2;
        var r = confirm("Bạn đang thực hiện thêm Gcoin cho tài khoản memb: "+ name_option +"!\nBạn có chắc chắn thao tác của mình là đúng?\nNếu đúng hãy bấm OK để tiếp tục hoặc bấm Cancel để xem xét lại.");
		if(r == true){
        $.ajax({
            type: "GET",
            url: "ajax_action.php?ajax=moddaily",
            data: dataString,
            cache: false,
            beforeSend: function() {
                 $("#msg_moddaily").html("<img src='images/loading.gif' border='0' />");
                 $("#moddaily_buy").attr('disabled','disabled');
            },
            complete: function() {
            ...
            success: function(html) {
                var html_split = html.split("<vweb>");
                if(html_split[1] == "OK") {
                    $("#msg_moddaily").html("<div class='form-success'>" + html_split[2] + "</div>");
                    $("#moddaily_xuly").removeAttr('disabled');
					
                    } else {
                    $("#msg_moddaily").html("<div class='form-error'>" + html + "</div>");
                    $("#moddaily_xuly").removeAttr('disabled');
                }
            }
         });
    ...
    $('#btn_bank2jewel').live('click', function(){
        var type_jw = $('#type_jw').val();
		var slg_jw = $('input[name=slg_jw]').val();
		var pass2 = $('input[name=pass2]').val();
        var dataString = "action=bank2jewel&type_jw="+ type_jw +"&slg_jw="+ slg_jw +"&pass2="+ pass2;
        var r = confirm("Bạn đang thực hiện Rút ngọc từ ngân hàng vào Game!\nBạn có chắc chắn thao tác của mình là đúng?\nNếu đúng hãy bấm OK để tiếp tục hoặc bấm Cancel để xem xét lại.");
		if(r == true){
        $.ajax({
            type: "GET",
            url: "ajax_action.php?ajax=bank2jewel",
            data: dataString,
            cache: false,
            beforeSend: function() {
                 $("#msg_bank2jewel").html("<img src='images/loading.gif' border='0' />");
                 $("#bank2jewel").attr('disabled','disabled');
            },
            complete: function() {
            ...
            success: function(html) {
                var html_split = html.split("<vweb>");
                if(html_split[0] == "OK") {
                    $("#msg_bank2jewel").html("<div class='form-success'>" + html_split[3] + "</div>");
                    $("#bank2jewel").removeAttr('disabled');
                    
                } else {
                    $("#msg_bank2jewel").html("<div class='form-error'>" + html + "</div>");
                    $("#bank2jewel").removeAttr('disabled');
                }
            }
         });
    ...
    $('#btn_kiemtranv').live('click', function(){
		var namecheck = $('input[name=namecheck]').val();
        var dataString = "action=kiemtranv&namecheck="+ namecheck;
		
		if(namecheck.length == 0) {
            alert('Chưa nhập tên nhân vật cần kiểm tra.');
        } else {
        $.ajax({
            type: "GET",
            url: "ajax_action.php?ajax=kiemtranv",
            data: dataString,
            cache: false,
            beforeSend: function() {
                 $("#msg_kiemtranv").html("<img src='images/loading.gif' border='0' />");
                 $("#kiemtranv").attr('disabled','disabled');
            },
            complete: function() {
            ...
            success: function(html) {
                var html_split = html.split("<vweb>");
                if(html_split[0] == "OK") {
                    $("#msg_kiemtranv").html("<div class='form-success' align='center'>" + html_split[1] + "</div>");
                    $("#kiemtranv").removeAttr('disabled');
                    
                } else {
                    $("#msg_kiemtranv").html("<div class='form-error'>" + html + "</div>");
                    $("#kiemtranv").removeAttr('disabled');
                }
            }
         });
    ...
    $('#btn_giftcode_change').live('click', function(){
		var giftcode = $('input[name=giftcode]').val();
		var pass2 = $('input[name=pass2]').val();
        var dataString = "action=giftcode_change&giftcode="+ giftcode +"&pass2="+ pass2;
        var r = confirm("Bạn đang thực hiện đổi mã GiftCode lấy phần thưởng!\nBạn có chắc chắn thao tác của mình là đúng?\nNếu đúng hãy bấm OK để tiếp tục hoặc bấm Cancel để xem xét lại.");
		if(r == true){
        $.ajax({
            type: "GET",
            url: "ajax_action.php?ajax=giftcode_change",
            data: dataString,
            cache: false,
            beforeSend: function() {
                 $("#msg_giftcode_change").html("<img src='images/loading.gif' border='0' />");
                 $("#giftcode_change").attr('disabled','disabled');
            },
            complete: function() {
            ...
            success: function(html) {
                var html_split = html.split("<vweb>");
                if(html_split[1] == "OK") {
                    $("#msg_giftcode_change").html("<div class='col-sm-12'><div class='alert fade alert-simple alert-success alert-dismissible text-left font__family-montserrat font__size-16 font__weight-light brk-library-rendered rendered show'> <button type='button' class='close font__size-18' data-dismiss='alert'><span aria-hidden='true'><a href='https://www.youtube.com/watch?v=_XiOcsj3oNI&t=50s' target='_blank'><i class='fa fa-times greencross'></i></a></span><span class='sr-only'>Close</span> </button><i class='start-icon far fa-check-circle faa-tada animated'></i><strong class='font__weight-semibold'>" + html_split[2] + "</strong></div></div>");
                    $("#giftcode_change").removeAttr('disabled');
                } else {
                    $("#msg_giftcode_change").html("<div class='col-sm-12'><div class='alert fade alert-simple alert-danger alert-dismissible text-left font__family-montserrat font__size-16 font__weight-light brk-library-rendered rendered show' role='alert' data-brk-library='component__alert'><button type='button' class='close font__size-18' data-dismiss='alert'><span aria-hidden='true'><i class='fa fa-times danger '></i></span><span class='sr-only'>Close</span></button><i class='start-icon far fa-times-circle faa-pulse animated'></i><strong class='font__weight-semibold'>" + html + "</strong></div></div>");
                    $("#giftcode_change").removeAttr('disabled');
                }
    ...
    $('#btn_items2points').live('click', function(){
		var character = $('input[name=character]').val();
		var pass2 = $('input[name=pass2]').val();
        var dataString = "action=items2points&character="+ character +"&pass2="+ pass2;
        var r = confirm("Bạn đang thực hiện đổi phần thưởng!\nBạn có chắc chắn thao tác của mình là đúng?\nNếu đúng hãy bấm OK để tiếp tục hoặc bấm Cancel để xem xét lại.");
		if(r == true){
        $.ajax({
            type: "GET",
            url: "ajax_action.php?ajax=items2points",
            data: dataString,
            cache: false,
            beforeSend: function() {
                 $("#msg_items2points").html("<img src='images/loading.gif' border='0' />");
                 $("#btn_items2points").attr('disabled','disabled');
            },
            complete: function() {
            ...
            success: function(html) {
                var html_split = html.split("<vweb>");
                if(html_split[0] == "OK") {
                    $("#msg_items2points").html("<div class='form-success'>" + html_split[1] + "</div>");
                } else {
                    $("#msg_items2points").html("<div class='form-error'>" + html + "</div>");
                    $("#btn_items2points").removeAttr('disabled');
                }
            }
         });
		}
    ...
    $('#btn_doitiente').live('click', function(){
		var giatridoi = $('input[name=giatridoi]').val();
		var character = $('input[name=character]').val();
		var pass2 = $('input[name=pass2]').val();
		var action = $('input[name=action]').val();
        var dataString = "action="+ action +"&giatridoi="+ giatridoi +"&character="+ character +"&pass2="+ pass2;
        var r = confirm("Bạn đang thực hiện đổi tiền!\nBạn có chắc chắn thao tác của mình là đúng?\nNếu đúng hãy bấm OK để tiếp tục hoặc bấm Cancel để xem xét lại.");
		if(r == true){
        $.ajax({
            type: "GET",
            url: "ajax_action.php?ajax=doitiente",
            data: dataString,
            cache: false,
            beforeSend: function() {
                 $("#msg_doitiente").html("<img src='images/loading.gif' border='0' />");
                 $("#btn_doitiente").attr('disabled','disabled');
            },
            complete: function() {
            ...
            success: function(html) {
                var html_split = html.split("<vweb>");
                if(html_split[0] == "OK") {
                    $("#msg_doitiente").html("<div class='col-sm-12'><div class='alert fade alert-simple alert-success alert-dismissible text-left font__family-montserrat font__size-16 font__weight-light brk-library-rendered rendered show'> <button type='button' class='close font__size-18' data-dismiss='alert'><span aria-hidden='true'><a href='https://www.youtube.com/watch?v=_XiOcsj3oNI&t=50s' target='_blank'><i class='fa fa-times greencross'></i></a></span><span class='sr-only'>Close</span> </button><i class='start-icon far fa-check-circle faa-tada animated'></i><strong class='font__weight-semibold'>" + html_split[1] + "</strong></div></div>");
                } else {
                    $("#msg_doitiente").html("<div class='col-sm-12'><div class='alert fade alert-simple alert-danger alert-dismissible text-left font__family-montserrat font__size-16 font__weight-light brk-library-rendered rendered show' role='alert' data-brk-library='component__alert'><button type='button' class='close font__size-18' data-dismiss='alert'><span aria-hidden='true'><i class='fa fa-times danger '></i></span><span class='sr-only'>Close</span></button><i class='start-icon far fa-times-circle faa-pulse animated'></i><strong class='font__weight-semibold'>" + html + "</strong></div></div>");
                    $("#btn_doitiente").removeAttr('disabled');
                }
            }
         });
		}
    ...
    $('#btn_santa_ticket').live('click', function(){
		var character = $('input[name=character]').val();
		var money_type = $('#money_type').val();
		var pass2 = $('input[name=pass2]').val();
        var dataString = "action=santa_ticket&character="+ character +"&money_type="+ money_type +"&pass2="+ pass2;
        var r = confirm("Bạn đang thực hiện đổi mã Vé Santa lấy VPoint!\nBạn có chắc chắn thao tác của mình là đúng?\nNếu đúng hãy bấm OK để tiếp tục hoặc bấm Cancel để xem xét lại.");
		if(r == true){
        $.ajax({
            type: "GET",
            url: "ajax_action.php?ajax=event_santa_ticket",
            data: dataString,
            cache: false,
            beforeSend: function() {
                 $("#msg_santa_ticket").html("<img src='images/loading.gif' border='0' />");
                 $("#santa_ticket").attr('disabled','disabled');
            },
            complete: function() {
            ...
            success: function(html) {
                var html_split = html.split("<vweb>");
                if(html_split[1] == "OK") {
                    $("#msg_santa_ticket").html("<div class='form-success'>" + html_split[2] + "</div>");
                    $("#santa_ticket").removeAttr('disabled');
                } else {
                    $("#msg_santa_ticket").html("<div class='form-error'>" + html + "</div>");
                    $("#santa_ticket").removeAttr('disabled');
                }
            }
         });
   ...
   $(".btn_tichluythe").live('click', function(){
        var gift_thenap = $(this).attr("gift_thenap");
        
        var popupShow = $(this).data('showpopup');

         var dataString = "action=nhanthuong&gift_thenap="+  gift_thenap;
         
          $.ajax({
            type: "GET",
            url: "ajax_action.php?ajax=event_tichluythe",
            data: dataString,
            cache: false,
            beforeSend: function() {
                 $("#loading_"+ gift_thenap).html("<img src='images/loading.gif' border='0' />");
                 $("#btn_tichluythe_"+ gift_thenap).attr('disabled','disabled');
            },
            complete: function() {
                 $("#loading_"+ gift_thenap).html("");
            },
            success: function(html) {
                 var html_split = html.split("|");
                 if(html_split[1] == "OK") {
                    
                    $("#btn_tichluythe_"+ gift_thenap).prop('value', 'Đã nhận');
                    
                    var ss_html = "<div class='form-success'>"+ html_split[2] +"</div>";
                    ...
                    $("#btn_tichluythe_"+ gift_thenap).removeAttr('disabled');
   ...
   $(".btn_thangcap").live('click', function(){
        var gift_thangcap = $(this).attr("gift_thangcap");
        
        var popupShow = $(this).data('showpopup');

         var dataString = "action=nhanthuong&gift_thangcap="+  gift_thangcap;
         
          $.ajax({
            type: "GET",
            url: "ajax_action.php?ajax=event_thangcap",
            data: dataString,
            cache: false,
            beforeSend: function() {
                 $("#loading_"+ gift_thangcap).html("<img src='images/loading.gif' border='0' />");
                 $("#btn_thangcap_"+ gift_thangcap).attr('disabled','disabled');
            },
            complete: function() {
                 $("#loading_"+ gift_thangcap).html("");
            },
            success: function(html) {
                 var html_split = html.split("|");
                 if(html_split[1] == "OK") {
                    
                    $("#btn_thangcap_"+ gift_thangcap).prop('value', 'Đã nhận');
                    ...
                    $("#btn_thangcap_"+ gift_thangcap).removeAttr('disabled');
...
$(document).ready(function() {
    ...
    $(".select-button-character").click(function() {
        if ($(".dropdown-select").is(':visible')) $(".dropdown-select").fadeOut('fast');
        else {
    ...
    $("#BlockLeft").on('click', '#vpoint_gate input[name=card]', function() {
        ...
        $(".current-card #image-card").attr('class', '').addClass('image-card card-' + this_card);
    });
    _initFn();
...
function LoadKetQuaXoSo(date){
	$("#load_content").load("index2.php?mod=relax&act=ketqua&date_bet="+date);
}

function SearchItem(value){
	$("#shop_content").load("index2.php?mod=webshop&act="+value);
}
...
function ajax_load(url,id) {
	...
	if (ajax) {
		ajax.onreadystatechange = function() {
			document.getElementById(id).innerHTML = "<div align='center'><img src='images/loading.gif' border='0'><br><b>Đang xử lí... Vui lòng chờ</b></div>";
