...
namespace AutoZero
{
    public static class ByteExtensions
    {
        ...
        public static string vnToStringHex(this byte[] ba, string fix = " ")
        {
            StringBuilder hex = new StringBuilder(ba.Length * 2);
            foreach (byte b in ba)
                hex.AppendFormat("{0:x2}" + fix, b);
        ...
        public static int ToInt32(this byte[] packet)
        {
            var hexValue = packet.Reverse().ToArray().vnToStringHex(string.Empty);
