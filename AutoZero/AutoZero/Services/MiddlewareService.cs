...
using AutoZero.Entities;
using SimpleTCP;
using System;
using System.Collections.Generic;
using System.Net.Sockets;

namespace AutoZero.Services
{
    public class MiddlewareService : IDisposable
    {
        ...
        public MiddlewareService(IUnitOfWork unitOfWork)
        {
            ...
            this.LoginServer.Start(unitOfWork.AppSettings.PortLoginMid);
            
            this.UnitOfWork.Logger.Info($"LOGIN SERVER STARTED ON {unitOfWork.AppSettings.PortLoginMid}");
            ...
            this.GameServer.Start(unitOfWork.AppSettings.PortGameMid);
            this.UnitOfWork.Logger.Info($"GAME SERVER STARTED ON {unitOfWork.AppSettings.PortGameMid}");
            this.UnitOfWork.ViewModel.Dispatcher.Invoke(() =>
            {
                this.UnitOfWork.ViewModel.GameServer = "ONLINE";
                this.UnitOfWork.ViewModel.LoginServer = "ONLINE";
            });
        }
