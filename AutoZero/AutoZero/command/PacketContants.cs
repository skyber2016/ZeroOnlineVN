...
namespace AutoZero.command
{
    public static class PacketContants
    {
        ...
        public static byte[] BUY_ATOM = new byte[] { 0x5F, 0x00, 0xF0, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0xEE, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xCA, 0x32, 0x0A, 0x03, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0xAA, 0x0F };
        public static byte[] PACKET_HAS_ATOM = BUY_ATOM;
        public static byte[] ADDINATION = new byte[] { 0x20, 0x00, 0xF9, 0x07 };
        public static byte[] ADDINATION_SUCCESS = new byte[] { 0x20, 0x00, 0xF1, 0x03 };
        public static byte[] USERNAME = new byte[] { 0x41, 0x00, 0xEC, 0x03 };
    }
}
