...
function logoimg(jz){
    if (jz==undefined || jz=="pc") {
        document.write("<a href='https://jz.99.com/index/' target='_blank' title='机战中文官方网站'><img onload='transPNGPic(this);' src='https://img5.99.com/jz/images/logo/logo0413.png'/></a>")
    } else if (jz=="pad") {
        document.write("<a href='http://wxjz.99.com/' target='_blank' title='机战Pad官网'><img onload='transPNGPic(this);' src='https://img5.99.com/wxjz/images/logo/logo.png'/></a>");
    } else if (jz=="jsz") {
        document.write("<a href='https://jz.99.com/index/' target='_blank' title='机战中文官方网站'><img onload='transPNGPic(this);' src='https://img5.99.com/jz/images/logo/logo0413.png'/></a>");
    }
}
...
var setLogo = function () {
    var logo = '<a href="https://jz.99.com/index/" title="机战中文官方网站"><img src="https://img5.99.com/jz/images/logo/logo0413.png" alt="机战中文官方网站" /></a>';
